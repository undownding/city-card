/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 821c590c22bbb20fb04749e5baa15793)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WEATHER_CARDS_R2_BUCKET: R2Bucket;
		"ai-gallery": Ai;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		GEMINI_API_KEY: string;
		AI_GATEWAY_GEMINI: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GEMINI_API_KEY" | "AI_GATEWAY_GEMINI" | "AI_GATEWAY_TOKEN">> {}
}
